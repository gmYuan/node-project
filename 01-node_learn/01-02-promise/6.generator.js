// 生成器: 在生成的过程中可以暂停，可以自己控制是否继续==> 可以用来生成 迭代器
...
let likeArray = {
  ...
  // () {
  //   let i = 0;
  //   // 一个对象有一个next方法，每次调用next 都会产生一个对象具备 {value done}
  //   return { 
  //     next:()=> {
...
// 调用了第一次next的时候 可以暂停逻辑
// 如果觉得这个逻辑有异常  后续可以通过throw方法抛出异常
// it.throw("错误"); 
